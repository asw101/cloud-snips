...
az group deployment create --resource-group $RESOURCE_GROUP --template-file azuredeploy-windows.json \
...
# with key
az group deployment create --resource-group $RESOURCE_GROUP --template-file azuredeploy-linux.json \
    --parameters adminPasswordOrKey="$PASSWORD_OR_KEY"
